    ...
    <div className="min-h-full pt-10 px-2 sm:p-4 md:px-10">
      <div className="flex items-center justify-between p-4">
        <div className="flex gap-6 items-center px-3">
          <button
            className="h-8 w-8 p-2 bg-cardbg rounded flex justify-center items-center cursor-pointer hover:bg-cardbg/50"
            onClick={() => history.back()}
          >
            <ArrowLeft className="h-4 w-4 text-text-primary" />
          </button>
          <div>
            <h1 className="text-text-primary text-2xl sm:text-3xl font-bold tracking-tighter">
              My Profile
            </h1>
            <p className="text-text-secondary text-sm sm:text-lg tracking-tighter">
              HeyMint – Simple. Secure. Smarter meetings.
            </p>
          </div>
        </div>
      ...
      <div className="bg-accent/30 backdrop-blur-md rounded-xl shadow-lg p-8 py-6 flex flex-col sm:flex-row justify-between gap-y-2">
        <div className="flex gap-4 items-center justify-center">
          ...
          <p className="text-text-primary font-bold text-lg sm:text-xl">
      ...
      <div className="bg-cardbg rounded-xl mt-5 p-5 flex flex-wrap md:flex-nowrap items-center justify-between gap-4 border-surface-2 border-2">
        ...
        <Button className="font-bold w-full sm:w-auto" onClick={handleUpdateProfile}>
          <Edit className="mr-2" />
